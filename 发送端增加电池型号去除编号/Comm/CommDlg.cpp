...
BOOL CCommDlg::OnInitDialog()
{
	...
	CComboBox* comboVoltage = (CComboBox*)GetDlgItem(IDC_COMBO_Voltage);
	comboVoltage->AddString(_T("锂电池36V 10/12/15AH"));
	comboVoltage->AddString(_T("锂电池48V 10/11/12AH"));
	comboVoltage->AddString(_T("锂电池48V 15/20AH"));
	comboVoltage->AddString(_T("锂电池60V 20AH"));
	comboVoltage->AddString(_T("铅酸电池36V 10/12/15AH"));
	comboVoltage->AddString(_T("铅酸电池36V 20/30AH"));
	comboVoltage->AddString(_T("铅酸电池48V 10/12/15AH"));
	comboVoltage->AddString(_T("铅酸电池48V 20AH"));
	comboVoltage->AddString(_T("铅酸电池48V 30AH"));
	comboVoltage->AddString(_T("铅酸电池60V 10/12/15AH"));
	comboVoltage->AddString(_T("铅酸电池60V 20AH"));
	comboVoltage->AddString(_T("铅酸电池60V 32AH"));
	comboVoltage->AddString(_T("铅酸电池72V 20AH"));
	comboVoltage->AddString(_T("铅酸电池72V 30AH"));
	/*CComboBox* combCur = (CComboBox*)GetDlgItem(IDC_COMBO_Cur);
	combCur->AddString(_T("10/12/15AH"));
	combCur->AddString(_T("20/30AH"));
	combCur->AddString(_T("10/11/12AH"));
	combCur->AddString(_T("15/20AH"));
	combCur->AddString(_T("20AH"));
	combCur->AddString(_T("30AH"));
	combCur->AddString(_T("32AH"));*/
...
{   
	...
	// 根据接收数据第二个字节分别写入不同的框
		...
		//if((RxLenTotal==440)){
			if((RxLenTotal==891)&&(rstr.Mid(2,2)=="4b")&&(rstr.Mid(8,2)=="1e")){
...
void CCommDlg::OnClickedButtonSend2()
{
	...
	GetDlgItemText(IDC_COMBO_Voltage,Voltage);
	//GetDlgItemText(IDC_COMBO_Cur,Cur);

	if((Voltage=="锂电池36V 10/12/15AH")){
		updVoltage = "1600";
		updCurrent = "2100";
	}
	else if((Voltage=="锂电池48V 10/11/12AH")){
		updVoltage = "2150";
		updCurrent = "2350";
	}
	else if((Voltage=="锂电池48V 15/20AH")){
		updVoltage = "2150";
		updCurrent = "3500";
	}
	else if((Voltage=="锂电池60V 20AH")){
		updVoltage = "2600";
		updCurrent = "3500";
	}
	else if((Voltage=="铅酸电池36V 10/12/15AH")){
		updVoltage = "1650";
		updCurrent = "2100";
	}
	else if((Voltage=="铅酸电池36V 20/30AH")){
		updVoltage = "1650";
		updCurrent = "2900";
	}
	else if((Voltage=="铅酸电池48V 10/12/15AH")){
		updVoltage = "2300";
		updCurrent = "2350";
	}
	else if((Voltage=="铅酸电池48V 20AH")){
		updVoltage = "2300";
		updCurrent = "3250";
	}
	else if((Voltage=="铅酸电池48V 30AH")){
		updVoltage = "2300";
		updCurrent = "3900";
	}
	else if((Voltage=="铅酸电池60V 10/12/15AH")){
		updVoltage = "2850";
		updCurrent = "2350";
	}
	else if((Voltage=="铅酸电池60V 20AH")){
		updVoltage = "2850";
		updCurrent = "3250";
	}
	else if((Voltage=="铅酸电池60V 32AH")){
		updVoltage = "2850";
		updCurrent = "3900";
	}
	else if((Voltage=="铅酸电池72V 20AH")){
		updVoltage = "3300";
		updCurrent = "3250";
	}
	else if((Voltage=="铅酸电池72V 30AH")){
		updVoltage = "3300";
		updCurrent = "3900";
	}
	else{
		MessageBox(_T("电池型号选择有误，请重新选择"));
		return;
	}
	// 获取电压限值
